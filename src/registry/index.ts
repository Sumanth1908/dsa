...
export const registry: ModuleSection[] = [
  ...
  // ── Data Structures ───────────────────────────────────────────────────────
  {
    ...
    subcategories: [
      { id: 'array', title: 'Array', path: '/data-structures/array', description: 'Numbered slots in memory — O(1) access by index, O(n) to shift when inserting in the middle', difficulty: 'beginner', tags: ['linear', 'O(1) access'] },
      { id: 'linked-list', title: 'Linked List', path: '/data-structures/linked-list', description: 'Nodes chained by pointers — O(1) head insert with no shifting, O(n) to find by index', difficulty: 'beginner', tags: ['pointers', 'dynamic'] },
      { id: 'stack', title: 'Stack', path: '/data-structures/stack', description: 'A pile of plates — only touch the top; powers the call stack, undo history, and DFS', difficulty: 'beginner', tags: ['LIFO', 'recursion'] },
      { id: 'queue', title: 'Queue', path: '/data-structures/queue', description: 'A line at checkout — first in, first served; the engine behind BFS and task scheduling', difficulty: 'beginner', tags: ['FIFO', 'BFS'] },
      { id: 'tree', title: 'Tree', path: '/data-structures/tree', description: 'Hierarchical structure — root, parent, child, leaf; foundation for BST, Heap, and Trie', difficulty: 'beginner', tags: ['hierarchy', 'traversal', 'recursive'] },
      { id: 'bst', title: 'Binary Search Tree', path: '/data-structures/bst', description: 'Left subtree < node < right subtree — binary search on a dynamic sorted container', difficulty: 'intermediate', tags: ['BST', 'traversal'] },
      { id: 'trie', title: 'Trie', path: '/data-structures/trie', description: 'Each edge is a character — O(m) prefix search, autocomplete, spell check', difficulty: 'intermediate', tags: ['prefix', 'strings', 'autocomplete'] },
      { id: 'graph', title: 'Graph', path: '/data-structures/graph', description: 'The most general structure — networks, maps, dependencies; every tree is a special-case graph', difficulty: 'intermediate', tags: ['BFS', 'DFS'] },
      { id: 'heap', title: 'Heap', path: '/data-structures/heap', description: 'Keeps the smallest (or largest) element at the root always — the natural priority queue', difficulty: 'intermediate', tags: ['priority queue', 'O(log n)'] },
    ],
  },
