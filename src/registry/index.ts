...
export const registry: ModuleSection[] = [
...

  {
    ...
    subcategories: [
      ...
      { id: 'distributed-databases', title: 'Distributed Databases', path: '/system-design/distributed-databases', description: 'Sharding, replicas, leader election, failover, quorums, and read/write routing', difficulty: 'advanced', tags: ['sharding', 'replication', 'leader election', 'failover', 'consistency'] },
